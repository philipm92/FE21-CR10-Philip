...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2021 at 01:13 PM
...
('UNKN0WN', 'Mit dir schlafen [Explicit] Single', 'CD', 'Alligatoah ist wieder da und im Gepäck hat er die pure Wahrheit. Seine brandneue frische Single \"Mit dir schlafen\" hat er am 25. Juni 2021 veröffentlicht. Mit auf die Scheibe hat sich die junge Esther Graf getraut.', '2021-06-25', 'mitdirschlafen.jpg', 1);
...
--
ALTER TABLE `biglibrary`
  ADD CONSTRAINT `biglibrary_ibfk_1` FOREIGN KEY (`FK_ISBN`) REFERENCES `media` (`ISBN`) ON DELETE CASCADE,
  ADD CONSTRAINT `biglibrary_ibfk_2` FOREIGN KEY (`FK_ID_author`) REFERENCES `author` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `biglibrary_ibfk_3` FOREIGN KEY (`FK_ID_publisher`) REFERENCES `publisher` (`id`) ON DELETE CASCADE;
COMMIT;
